...
return [
    ...
    */
    ...
    'key' => env('STRIPE_KEY', config('constants.stripe_key')),

    'secret' => env('STRIPE_SECRET', config('constants.stripe_secret')),
    ...
    */
    ...
    'webhook' => [
        'secret' => env('STRIPE_WEBHOOK_SECRET', 'whsec_jcBgMPU6GA1e9Tv6cKZvIM6tvzOmBkwH'),
    ...
    */
    ...
    'currency' => env('CASHIER_CURRENCY', config('constants.£')),
